...
function dntheme_get_wmpl($value='')
{
    if(in_array('wpml-translation-management/plugin.php', apply_filters('active_plugins', get_option('active_plugins')))){
        ...
        <div class="languages__label">
            <img src="<?php echo get_theme_file_uri('assets/flag/'.$currentLang.'.png') ?>" width="<?php echo $flag_width ?>" height="<?php echo $flag_height ?>" alt="">
        </div>
        <div class="languages__content">
            <p class="languages__text"><?php _e('Select language','dntheme'); ?></p>
            <ul class="">
            <?php foreach (icl_get_languages() as $key => $value) {
                ...
                <li class="<?php echo $class_active ?>">
                    ...
                    <span><?php echo $value['translated_name'] ?></span>
                    </a>
                </li>
                <?php
            } ?>
